...
module.exports = {
  ...
  execute : function(command) {
    ...
    .then( jsx => new Promise( resolve => {
      //"m" flag enables opening multiple instances of AE.
      //TODO: Make this configurable, and available on Mac.
      exec(`afterfx.exe -m -r ${jsx.script}`, {cwd: jsx.program_path}, (/*err, stdout, stderr*/) => {
        // see * below
  ...
  executeSync : function(command) {
    ...
    try {
      //"m" flag enables opening multiple instances of AE.
      //TODO: Make this configurable, and available on Mac.
      execSync(`afterfx.exe -m -r ${jsx.script}`, {cwd: jsx.program_path});
    } catch (err) {
      //TODO *
