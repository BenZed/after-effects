...
function getRenderEngineUrl(aeUrl: string) {
...
function writeAppleScriptSync(adobified: string, aeUrl: string, renderEngine: boolean) {
    ...
    try {
        ...
        throw new CouldNotCreateAppleScriptError((err as Error).message)
    }

    return scptUrl
}

async function writeAppleScript(adobified: string, aeUrl: string, renderEngine: boolean) {
